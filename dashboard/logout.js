function logout(r = null) {
    ...
    setTimeout(() => {
        if (urlParams.has('page') && r) {
            ...
            document.location.href = `/looped/login/?out=true&r=${encodeURI(String(r))}&p=${urlParams.get('page')}`
        } else if (r) {
            ...
            document.location.href = `/looped/login/?out=true&r=${encodeURI(String(r))}`
            ...
            document.location.href = `/looped/login/?out=true&p=${urlParams.get('page')}`
        } else {
            ...
            document.location.href = `/looped/login/?out=true`
        }
    }, 500)
}
